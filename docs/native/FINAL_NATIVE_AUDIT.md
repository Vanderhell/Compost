...
Python tests:
`214 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (80.77s).
...
Differential cases:
`23` Python/native differential tests pass, including bounded pure-rule,
