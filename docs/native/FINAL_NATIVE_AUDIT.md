...
Python tests:
`250 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (95.15s).
...
Differential cases:
`54` Python/native differential tests pass, including bounded pure-rule,
