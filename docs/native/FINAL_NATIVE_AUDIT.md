...
Python tests:
`232 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (86.45s).
...
Differential cases:
`39` Python/native differential tests pass, including bounded pure-rule,
