...
Python tests:
`218 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (84.56s).
...
Differential cases:
`26` Python/native differential tests pass, including bounded pure-rule,
