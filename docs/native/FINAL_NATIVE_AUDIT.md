...
Python tests:
`215 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (81.15s).
...
Differential cases:
`24` Python/native differential tests pass, including bounded pure-rule,
