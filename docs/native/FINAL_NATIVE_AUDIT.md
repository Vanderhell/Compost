...
Python tests:
`247 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (101.27s).
...
Differential cases:
`51` Python/native differential tests pass, including bounded pure-rule,
