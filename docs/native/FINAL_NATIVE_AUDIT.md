...
Python tests:
`219 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (82.13s).
...
Differential cases:
`27` Python/native differential tests pass, including bounded pure-rule,
