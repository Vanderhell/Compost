...
Python tests:
`217 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (83.19s).
...
Differential cases:
`25` Python/native differential tests pass, including bounded pure-rule,
