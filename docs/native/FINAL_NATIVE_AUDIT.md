...
Python tests:
`237 passed, 3 subtests passed` in the latest complete local run with the
native DLL configured (88.46s).
...
Differential cases:
`44` Python/native differential tests pass, including bounded pure-rule,
