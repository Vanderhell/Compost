...
The matching Windows GCC 16.1 Release build also passed the complete CTest
set, including fuzz and width targets: `8/8` in `13.53s`.
...
with the same fuzz and width checks (`8/8`, `99.67s`).
