...
to Python fallback. The current bounded campaign contains twenty-eight tests,
...
green (`28 passed`), and the complete Python regression suite is green
(`220 passed, 3 subtests passed`). The selected partition
