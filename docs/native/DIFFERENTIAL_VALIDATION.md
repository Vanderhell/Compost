...
to Python fallback. The current bounded campaign contains twenty-five tests,
...
green (`25 passed`), and the complete Python regression suite is green
(`216 passed, 3 subtests passed`). The selected partition
