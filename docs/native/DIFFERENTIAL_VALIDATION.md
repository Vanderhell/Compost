...
to Python fallback. The current bounded campaign contains twenty-seven tests,
...
green (`27 passed`), and the complete Python regression suite is green
(`219 passed, 3 subtests passed`). The selected partition
