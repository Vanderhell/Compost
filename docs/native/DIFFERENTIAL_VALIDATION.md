...
to Python fallback. The current bounded campaign contains thirteen tests,
...
green (`13 passed`), and the complete Python regression suite is green
(`189 passed, 13 skipped, 3 subtests passed`). The selected partition
