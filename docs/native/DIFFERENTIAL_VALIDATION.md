...
to Python fallback. The current bounded campaign contains fourteen tests,
...
green (`14 passed`), and the complete Python regression suite is green
(`189 passed, 14 skipped, 3 subtests passed`). The selected partition
