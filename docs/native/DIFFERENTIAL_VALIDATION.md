...
to Python fallback. The current bounded campaign contains thirty-nine tests,
...
green (`39 passed`), and the complete Python regression suite is green
(`232 passed, 3 subtests passed`). The selected partition
