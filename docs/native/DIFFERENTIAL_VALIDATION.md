...
to Python fallback. The current bounded campaign contains twenty-four tests,
...
green (`24 passed`), and the complete Python regression suite is green
(`215 passed, 3 subtests passed`). The selected partition
