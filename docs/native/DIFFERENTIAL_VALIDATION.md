...
to Python fallback. The current bounded campaign contains twenty-six tests,
...
green (`26 passed`), and the complete Python regression suite is green
(`218 passed, 3 subtests passed`). The selected partition
