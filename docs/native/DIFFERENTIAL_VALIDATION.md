...
to Python fallback. The current bounded campaign contains twenty-two tests,
...
green (`22 passed`), and the complete Python regression suite is green
(`213 passed, 3 subtests passed`). The selected partition
