...
to Python fallback. The current bounded campaign contains twenty-three tests,
...
green (`23 passed`), and the complete Python regression suite is green
(`214 passed, 3 subtests passed`). The selected partition
